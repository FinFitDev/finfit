              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InputWithIcon(
                      placeholder: 'Imię *',
                      initialValue: _formInitialsState[USER_DATA_INPUTS.NAME],
                      onChange: (e) {
                        setState(() {
                          _formFieldsState[USER_DATA_INPUTS.NAME] = e.trim();
                    ...
                    InputWithIcon(
                      ...
                      onChange: (e) {
                        setState(() {
                          _formFieldsState[USER_DATA_INPUTS.SURNAME] = e.trim();
                    ...
                    InputWithIcon(
                      placeholder: 'E-mail *',
                      initialValue: _formInitialsState[USER_DATA_INPUTS.EMAIL],
                      onChange: (e) {
                        setState(() {
                          _formFieldsState[USER_DATA_INPUTS.EMAIL] = e.trim();
                    ...
                    InputWithIcon(
                      ...
                      error: _formErrorsState[USER_DATA_INPUTS.PHONE_NUMBER],
                      verticalPadding: 12,
                      borderRadius: 10,
                    ),
                    InputWithIcon(
                      placeholder: 'Ulica *',
                      initialValue: _formInitialsState[USER_DATA_INPUTS.STREET],
                      onChange: (e) {
                        setState(() {
                          _formFieldsState[USER_DATA_INPUTS.STREET] = e.trim();
                        ...
                        Expanded(
                          child: InputWithIcon(
                            ...
                            onChange: (e) {
                              setState(() {
                                _formFieldsState[
                                    USER_DATA_INPUTS.HOUSE_NUMBER] = e.trim();
                                _formErrorsState[
                                    USER_DATA_INPUTS.HOUSE_NUMBER] = '';
                              });
                            },
                            ...
                            error:
                                _formErrorsState[USER_DATA_INPUTS.HOUSE_NUMBER],
                            verticalPadding: 12,
                            borderRadius: 10,
                          ),
                        ),
                            ...
                            onChange: (e) {
                              setState(() {
                                _formFieldsState[USER_DATA_INPUTS.FLAT_NUMBER] =
                                    e.trim();
                                _formErrorsState[USER_DATA_INPUTS.FLAT_NUMBER] =
                                    '';
                              });
                            },
                      ...
                      children: [
                            ...
                            onChange: (e) async {
                              ...
                              setState(() {
                                _formFieldsState[USER_DATA_INPUTS.POST_CODE] =
                                    e.trim();
                                _formErrorsState[USER_DATA_INPUTS.POST_CODE] =
                                    '';
                              });
                            },
                            error: _formErrorsState[USER_DATA_INPUTS.POST_CODE],
                        ...
                        Expanded(
                          child: InputWithIcon(
                            ...
                            error: _formErrorsState[USER_DATA_INPUTS.CITY],
                    ...
                    InputWithIcon(
                      ...
                      onChange: (e) {
                        setState(() {
                          _formFieldsState[USER_DATA_INPUTS.COMPANY_NAME] =
                              e.trim();
                          _formErrorsState[USER_DATA_INPUTS.COMPANY_NAME] = '';
                        });
                      },
                      error: _formErrorsState[USER_DATA_INPUTS.COMPANY_NAME],
                    ...
                    InputWithIcon(
                      inputType: TextInputType.number,
                      initialValue: _formInitialsState[USER_DATA_INPUTS.NIP],
                      placeholder: 'NIP',
                      onChange: (e) {
                        setState(() {
                          _formFieldsState[USER_DATA_INPUTS.NIP] = e.trim();
              ...
              builder: (context, snapshot) {
                return MainButton(
                    ...
                    onPressed: () {
                      ...
                      if (snapshot.data?.orderId != null &&
                          snapshot.data!.orderId!.isNotEmpty) {
                        checkoutController.changeOrderUserData(
                            snapshot.data!.orderId!, userOrderData);
                      }

                      if (snapshot.data?.deliveryMethod != null &&
                          (snapshot.data!.deliveryMethod!.uuid ==
                                  COURIER_DB_UUID ||
                              snapshot.data!.deliveryMethod!.uuid ==
